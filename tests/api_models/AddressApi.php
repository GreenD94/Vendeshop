...
class AddressApi
{
    ...
    {
        return [
            "mainApiName" => 'api.mobile.address.store',
    ...
    {
        return [
            "mainApiName" => 'api.mobile.address.index',
            "mainModelName" => address::class,
            "mainApiMethod" => 'get',
            "mainApiModelName" => AddressApi::class
        ];
    ...
    {
        if ($mainApiName == 'api.mobile.address.destroy' || $mainApiName == 'api.mobile.address.update')
            return $response
                ->assertJson(
        ...
        if ($mainApiName == 'api.mobile.address.store')
            return $response
                ->assertJson(
                    fn (AssertableJson $json) =>
                    $json->has('message')
