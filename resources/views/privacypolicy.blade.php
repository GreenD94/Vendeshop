...
<body style="background-color:white">
    <div style="text-align: center;margin: 50px 50px 0px 50px;">
...
background-color: white">
        ...
        <ul>
            <li>
                <p>El presente Política de Privacidad establece los términos en que usa y protégé la información
                    que es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía
                    está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos llenar
                    los campos de información personal con la cual usted pueda ser identificado, lo hacemos
        ...
        <ul>
            <li>
                <p>
                    ...
                    contacto como su dirección de correo electrónico e información demográfica. Así mismo cuando
        ...
        <ul>
            <li>
                ...
                <p>
                    Vende-Shop está altamente comprometido para cumplir con el compromiso de mantener su
        ...
        <ul>
            <li>
                ...
                <p>
                    ...
                    mayoría de navegadores aceptan cookies automáticamente pues sirve para tener un mejor servicio web.
        ...
        <ul>
            <li>
                <p>
                    ...
                    sobre al sitio al que es redié y por lo tanto no somos responsables de los términos o
        ...
        <ul>
            <li>
                ...
                <p>
                    Vende-Shop Se reserva el derecho de cambiar los términos de la presente Política de
